# Reto
## Descripción
n you break into this super secure portal?http://fickle-tempest.picoctf.net:52245
## Solución
### Solucion
```
abrimos el inspeccionar y el index
...
ordenamos los split del split al split 8
```
