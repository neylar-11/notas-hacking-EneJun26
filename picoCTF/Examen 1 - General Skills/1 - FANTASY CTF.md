# Reto
## Descripción
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF.Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 56274`
## Solución
### Solucion

```
neylar11-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 56274
...
## Notas
solo me conecte a un servidor que es interactivo, la primera opcion no funciono pero al elegir la opcion de jugar salio la bandera.
